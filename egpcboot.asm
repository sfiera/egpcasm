...
;                  EPOCH GAME MASK ROM
;------------------------------------------------------------
RESET___0000:   #d8 $00                                         ; NOP
________0001:   #d8 $48, $24                                    ; DI
________0003:   #d8 $CF                                         ; JR      0013
;------------------------------------------------------------
INT0____0004:   #d8 $54, $0C, $40                               ; JMP     400C
________0007:   #d8 $00                                         ; NOP
;------------------------------------------------------------
...
CALT_96_000A:   #d8 $2F                                         ; LDAX    H-
________000B:   #d8 $3E                                         ; STAX    D-
________000C:   #d8 $52                                         ; DCR     B
________000D:   #d8 $FC                                         ; JR      000A
________000E:   #d8 $08                                         ; RET
________000F:   #d8 $00                                         ; NOP
;------------------------------------------------------------
...
CALT_A1_005F:   #d8 $2C                                         ; LDAX    D+
________0060:   #d8 $70, $E5                                    ; SUBX    H+
________0062:   #d8 $08                                         ; RET
;------------------------------------------------------------
...
________0066:   #d8 $C1                                         ; JR      0068
________0067:   #d8 $08                                         ; RET

________0068:   #d8 $52                                         ; DCR     B
________0069:   #d8 $F9                                         ; JR      0063
________006A:   #d8 $60, $91                                    ; XRA     A,A
________006C:   #d8 $08                                         ; RET
;------------------------------------------------------------
...
________007C:   #d8 $C1                                         ; JR      007E
________007D:   #d8 $08                                         ; RET

________007E:   #d8 $95                                         ; CALT    00AA	; "((HL+) ==> (DE+))xB"
________007F:   #d8 $08                                         ; RET
;------------------------------------------------------------
...
________00F3:   #d8 $4E, $66                                    ; JRE     015B

________00F5:   #d8 $30, $9A                                    ; DCRW    9A
________00F7:   #d8 $4E, $5F                                    ; JRE     0158

________00F9:   #d8 $48, $0E                                    ; PUSH    V
________00FB:   #d8 $28, $8F                                    ; LDAW    8F
________00FD:   #d8 $38, $9A                                    ; STAW    9A
________00FF:   #d8 $30, $99                                    ; DCRW    99
________0101:   #d8 $4E, $2B                                    ; JRE     012E

________0103:   #d8 $48, $1E                                    ; PUSH    B
________0105:   #d8 $48, $2E                                    ; PUSH    D
________0107:   #d8 $48, $3E                                    ; PUSH    H
________0109:   #d8 $69, $03                                    ; MVI     A,03
________010B:   #d8 $4D, $C9                                    ; MOV     TMM,A	;Adjust timer
________010D:   #d8 $69, $53                                    ; MVI     A,53
________010F:   #d8 $51                                         ; DCR     A
________0110:   #d8 $FE                                         ; JR      010F
________0111:   #d8 $45, $80, $02                               ; ONIW    80,02
________0114:   #d8 $C7                                         ; JR      011C

________0115:   #d8 $70, $3F, $84, $FF                          ; LHLD    FF84
________0119:   #d8 $78, $A9                                    ; CALF    08A9	;Music-playing code...
________011B:   #d8 $CC                                         ; JR      0128

________011C:   #d8 $05, $80, $FC                               ; ANIW    80,FC
________011F:   #d8 $69, $07                                    ; MVI     A,07
________0121:   #d8 $4D, $C9                                    ; MOV     TMM,A
________0123:   #d8 $69, $74                                    ; MVI     A,74
________0125:   #d8 $4D, $C6                                    ; MOV     T0,A
________0127:   #d8 $19                                         ; STM
________0128:   #d8 $48, $3F                                    ; POP     H
________012A:   #d8 $48, $2F                                    ; POP     D
________012C:   #d8 $48, $1F                                    ; POP     B
________012E:   #d8 $28, $88                                    ; LDAW    88
________0130:   #d8 $46, $01                                    ; ADI     A,01
________0132:   #d8 $61                                         ; DAA
________0133:   #d8 $38, $88                                    ; STAW    88
________0135:   #d8 $48, $1A                                    ; SKN     CY
________0137:   #d8 $C1                                         ; JR      0139
________0138:   #d8 $D5                                         ; JR      014E

________0139:   #d8 $20, $89                                    ; INRW    89
________013B:   #d8 $00                                         ; NOP
________013C:   #d8 $28, $87                                    ; LDAW    87
________013E:   #d8 $46, $01                                    ; ADI     A,01
________0140:   #d8 $61                                         ; DAA
________0141:   #d8 $38, $87                                    ; STAW    87
________0143:   #d8 $48, $1A                                    ; SKN     CY
________0145:   #d8 $C1                                         ; JR      0147
________0146:   #d8 $C7                                         ; JR      014E

________0147:   #d8 $28, $86                                    ; LDAW    86
________0149:   #d8 $46, $01                                    ; ADI     A,01
________014B:   #d8 $61                                         ; DAA
...
________0155:   #d8 $00                                         ; NOP
________0156:   #d8 $48, $0F                                    ; POP     V
;--------
________0158:   #d8 $48, $20                                    ; EI
________015A:   #d8 $62                                         ; RETI
;------------------------------------------------------------
________015B:   #d8 $48, $0E                                    ; PUSH    V
________015D:   #d8 $48, $1E                                    ; PUSH    B
...
________0177:   #d8 $48, $30                                    ; RAL
________0179:   #d8 $48, $30                                    ; RAL
________017B:   #d8 $1A                                         ; MOV     B,A
________017C:   #d8 $48, $2F                                    ; POP     D
________017E:   #d8 $48, $2E                                    ; PUSH    D
...
________018C:   #d8 $4F, $9A                                    ; JRE     0128
;------------------------------------------------------------
...
CALT_82_018E:   #d8 $48, $24                                    ; DI
________0190:   #d8 $48, $3F                                    ; POP     H
________0192:   #d8 $2D                                         ; LDAX    H+		;(PC+1)
________0193:   #d8 $1A                                         ; MOV     B,A
________0194:   #d8 $2D                                         ; LDAX    H+          ;(PC+1)
________0195:   #d8 $48, $3E                                    ; PUSH    H
________0197:   #d8 $38, $99                                    ; STAW    99
________0199:   #d8 $78, $B6                                    ; CALF    08B6        ;Set note timers
________019B:   #d8 $C7                                         ; JR      01A3
;------------------------------------------------------------
;Setup/Play Music
...
CALT_83_019C:   #d8 $48, $24                                    ; DI
________019E:   #d8 $15, $80, $02                               ; ORIW    80,02
________01A1:   #d8 $78, $A9                                    ; CALF    08A9	;Read notes & set timers
________01A3:   #d8 $48, $20                                    ; EI			;(sometimes skipped)
________01A5:   #d8 $08                                         ; RET
;------------------------------------------------------------
...
________01A9:   #d8 $2B                                         ; LDAX    H
________01AA:   #d8 $77, $55                                    ; EQI     A,55
________01AC:   #d8 $18                                         ; RETS

________01AD:   #d8 $85                                         ; CALT    008A	; "Clear A"
________01AE:   #d8 $38, $89                                    ; STAW    89
________01B0:   #d8 $2B                                         ; LDAX    H
________01B1:   #d8 $77, $55                                    ; EQI     A,55
________01B3:   #d8 $18                                         ; RETS
;----------------------------------
________01B4:   #d8 $75, $89, $03                               ; EQIW    89,03
________01B7:   #d8 $F8                                         ; JR      01B0

________01B8:   #d8 $7E, $4D                                    ; CALF    0E4D	;Sets a timer
________01BA:   #d8 $15, $80, $80                               ; ORIW    80,80
________01BD:   #d8 $32                                         ; INX     H           ;->$4001
________01BE:   #d8 $48, $1F                                    ; POP     B
________01C0:   #d8 $29                                         ; LDAX    B
________01C1:   #d8 $67, $C0                                    ; NEI     A,C0        ;To cart if it's $C0
________01C3:   #d8 $C4                                         ; JR      01C8

________01C4:   #d8 $32                                         ; INX     H           ;->$4003
________01C5:   #d8 $32                                         ; INX     H
________01C6:   #d8 $51                                         ; DCR     A
________01C7:   #d8 $F9                                         ; JR      01C1

________01C8:   #d8 $2D                                         ; LDAX    H+
________01C9:   #d8 $1B                                         ; MOV     C,A
________01CA:   #d8 $2B                                         ; LDAX    H
________01CB:   #d8 $1A                                         ; MOV     B,A
________01CC:   #d8 $73                                         ; JB                  ;Jump to cartridge!
;-----------------------------------------------------------
;CALT 00A0, CALT 00A4
...
________01DD:   #d8 $0A                                         ; MOV     A,B
________01DE:   #d8 $4D, $C1                                    ; MOV     PB,A        ;Port B = (A)
...
________020F:   #d8 $0A                                         ; MOV     A,B
________0210:   #d8 $4D, $C1                                    ; MOV     PB,A
...
________026C:   #d8 $E4                                         ; JR      0251

________026D:   #d8 $0A                                         ; MOV     A,B
________026E:   #d8 $26, $40                                    ; ADINC   A,40
________0270:   #d8 $C3                                         ; JR      0274
________0271:   #d8 $1A                                         ; MOV     B,A
________0272:   #d8 $4F, $CD                                    ; JRE     0241

________0274:   #d8 $64, $88, $DF                               ; ANI     PA,DF       ;bit 5 off
________0277:   #d8 $08                                         ; RET
;-----------------------------------------------------------
...
________05C7:   #d8 $C9                                         ; JR      05D1        ;Jump to graphic program

________05C8:   #d8 $75, $8A, $80                               ; EQIW    8A,80       ;Delay for the scrolltext
________05CB:   #d8 $4F, $DC                                    ; JRE     05A9        ;JRE Main Loop
________05CD:   #d8 $7C, $E2                                    ; CALF    0CE2        ;Scroll Text routine
________05CF:   #d8 $4F, $D4                                    ; JRE     05A5        ;Reset scrolltext delay...
;-----------------------------------------------------------
...
________05E1:   #d8 $3D                                         ; STAX    H+
________05E2:   #d8 $32                                         ; INX     H
________05E3:   #d8 $3B                                         ; STAX    H
________05E4:   #d8 $41                                         ; INR     A
________05E5:   #d8 $34, $70, $C5                               ; LXI     H,C570
________05E8:   #d8 $3D                                         ; STAX    H+
________05E9:   #d8 $41                                         ; INR     A
...
________05FE:   #d8 $3D                                         ; STAX    H+		;Just writes "99s" 3 bytes apart
________05FF:   #d8 $32                                         ; INX     H
________0600:   #d8 $32                                         ; INX     H
________0601:   #d8 $52                                         ; DCR     B
________0602:   #d8 $FB                                         ; JR      05FE
________0603:   #d8 $7D, $68                                    ; CALF    0D68        ;Draw Border
...
________0663:   #d8 $C8                                         ; JR      066C        ;Set a dot
...
________0677:   #d8 $4F, $8C                                    ; JRE     0605
________0679:   #d8 $47, $01                                    ; ONI     A,01        ;Up
________067B:   #d8 $D8                                         ; JR      0694

________067C:   #d8 $28, $A7                                    ; LDAW    A7
________067E:   #d8 $67, $0E                                    ; NEI     A,0E        ;Check lower limits of X-pos
________0680:   #d8 $DA                                         ; JR      069B

________0681:   #d8 $51                                         ; DCR     A
________0682:   #d8 $38, $A7                                    ; STAW    A7
________0684:   #d8 $51                                         ; DCR     A
________0685:   #d8 $70, $79, $71, $C5                          ; MOV     C571,A
...
________0693:   #d8 $DA                                         ; JR      06AE

________0694:   #d8 $47, $04                                    ; ONI     A,04        ;Down
________0696:   #d8 $D7                                         ; JR      06AE

________0697:   #d8 $28, $A7                                    ; LDAW    A7
________0699:   #d8 $67, $3A                                    ; NEI     A,3A        ;Check lower cursor limit
________069B:   #d8 $DB                                         ; JR      06B7

________069C:   #d8 $41                                         ; INR     A
________069D:   #d8 $38, $A7                                    ; STAW    A7
________069F:   #d8 $51                                         ; DCR     A
________06A0:   #d8 $70, $79, $71, $C5                          ; MOV     C571,A
...
________06B2:   #d8 $D9                                         ; JR      06CC

________06B3:   #d8 $28, $A6                                    ; LDAW    A6
________06B5:   #d8 $67, $43                                    ; NEI     A,43
________06B7:   #d8 $DC                                         ; JR      06D4

________06B8:   #d8 $41                                         ; INR     A
________06B9:   #d8 $38, $A6                                    ; STAW    A6
________06BB:   #d8 $51                                         ; DCR     A
________06BC:   #d8 $70, $79, $70, $C5                          ; MOV     C570,A
...
________06CE:   #d8 $4F, $35                                    ; JRE     0605
________06D0:   #d8 $28, $A6                                    ; LDAW    A6
________06D2:   #d8 $67, $07                                    ; NEI     A,07
________06D4:   #d8 $D3                                         ; JR      06E8

________06D5:   #d8 $51                                         ; DCR     A
________06D6:   #d8 $38, $A6                                    ; STAW    A6
________06D8:   #d8 $51                                         ; DCR     A
________06D9:   #d8 $70, $79, $70, $C5                          ; MOV     C570,A
...
________06E7:   #d8 $E2                                         ; JR      06CA
;------------------------------------------------------------
________06E8:   #d8 $82                                         ; CALT    0084	;[PC+2] Setup/Play Sound
________06E9:   #d8 $01, $03                                    ; DB $01,$03
________06EB:   #d8 $FB                                         ; JR      06E7
;------------------------------------------------------------
;Puzzle Setup Routines...
________06EC:   #d8 $7E, $4D                                    ; CALF    0E4D	;Reset the timer?
________06EE:   #d8 $69, $21                                    ; MVI     A,21
________06F0:   #d8 $6A, $0A                                    ; MVI     B,0A
________06F2:   #d8 $7E, $67                                    ; CALF    0E67	;LXI H,$C7F2
________06F4:   #d8 $3D                                         ; STAX    H+
________06F5:   #d8 $41                                         ; INR     A           ;Set up the puzzle tiles in RAM
________06F6:   #d8 $52                                         ; DCR     B
________06F7:   #d8 $FC                                         ; JR      06F4
________06F8:   #d8 $0A                                         ; MOV     A,B         ;$FF
________06F9:   #d8 $3D                                         ; STAX    H+
...
________072A:   #d8 $48, $1E                                    ; PUSH    B
________072C:   #d8 $48, $3E                                    ; PUSH    H
________072E:   #d8 $7D, $D3                                    ; CALF    0DD3        ;This probably draws the tiles
________0730:   #d8 $00                                         ; NOP                 ;Or randomizes them??
________0731:   #d8 $48, $3F                                    ; POP     H
________0733:   #d8 $48, $1F                                    ; POP     B
________0735:   #d8 $52                                         ; DCR     B
________0736:   #d8 $F2                                         ; JR      0729
...
________077B:   #d8 $2D                                         ; LDAX    H+
________077C:   #d8 $48, $1E                                    ; PUSH    B
________077E:   #d8 $48, $3E                                    ; PUSH    H
________0780:   #d8 $7D, $D3                                    ; CALF    0DD3	;Draw Tiles
________0782:   #d8 $00                                         ; NOP
________0783:   #d8 $48, $3F                                    ; POP     H
________0785:   #d8 $48, $1F                                    ; POP     B
________0787:   #d8 $52                                         ; DCR     B
________0788:   #d8 $F2                                         ; JR      077B
________0789:   #d8 $7D, $68                                    ; CALF    0D68        ;Draw Border (again)
________078B:   #d8 $7D, $92                                    ; CALF    0D92        ;Draw the grid (again)
...
________07B1:   #d8 $C2                                         ; JR      07B4
________07B2:   #d8 $4F, $A0                                    ; JRE     0754        ;Restart puzzle
;------------------------------------------------------------
________07B4:   #d8 $75, $8A, $80                               ; EQIW    8A,80
________07B7:   #d8 $4F, $DA                                    ; JRE     0793
________07B9:   #d8 $28, $92                                    ; LDAW    92          ;Joypad
________07BB:   #d8 $47, $0F                                    ; ONI     A,0F
________07BD:   #d8 $4F, $D0                                    ; JRE     078F        ;Keep looping
________07BF:   #d8 $7D, $D3                                    ; CALF    0DD3        ;Draw Tiles
________07C1:   #d8 $C4                                         ; JR      07C6
;------------------------------------------------------------
________07C2:   #d8 $82                                         ; CALT    0084	;[PC+2] Setup/Play Sound
________07C3:   #d8 $01, $03                                    ; DB $01,$03
________07C5:   #d8 $F7                                         ; JR      07BD
;------------------------------------------------------------
________07C6:   #d8 $48, $0E                                    ; PUSH    V
________07C8:   #d8 $69, $03                                    ; MVI     A,03
________07CA:   #d8 $38, $99                                    ; STAW    99
________07CC:   #d8 $48, $24                                    ; DI  
________07CE:   #d8 $78, $B6                                    ; CALF    08B6        ;Play Music (Snd)
________07D0:   #d8 $48, $20                                    ; EI
________07D2:   #d8 $34, $FE, $C7                               ; LXI     H,C7FE
________07D5:   #d8 $2D                                         ; LDAX    H+
________07D6:   #d8 $1A                                         ; MOV     B,A
________07D7:   #d8 $2F                                         ; LDAX    H-
________07D8:   #d8 $60, $BA                                    ; LTA     A,B
________07DA:   #d8 $C2                                         ; JR      07DD
________07DB:   #d8 $1A                                         ; MOV     B,A
________07DC:   #d8 $2B                                         ; LDAX    H
________07DD:   #d8 $48, $1E                                    ; PUSH    B
...
________081C:   #d8 $48, $30                                    ; RAL
________081E:   #d8 $3C                                         ; STAX    D+
________081F:   #d8 $52                                         ; DCR     B
________0820:   #d8 $FA                                         ; JR      081B
________0821:   #d8 $4E, $52                                    ; JRE     0875
;------------------------------------------------------------
________0823:   #d8 $7C, $BF                                    ; CALF    0CBF        ;Write Text(?)
________0825:   #d8 $6A, $07                                    ; MVI     B,07
________0827:   #d8 $32                                         ; INX     H
________0828:   #d8 $52                                         ; DCR     B
________0829:   #d8 $FD                                         ; JR      0827
...
________0840:   #d8 $C1                                         ; JR      0842
________0841:   #d8 $CA                                         ; JR      084C

________0842:   #d8 $38, $A5                                    ; STAW    A5
________0844:   #d8 $48, $1F                                    ; POP     B
________0846:   #d8 $0A                                         ; MOV     A,B
________0847:   #d8 $38, $A2                                    ; STAW    A2
________0849:   #d8 $7C, $BF                                    ; CALF    0CBF        ;Write Text(?)
________084B:   #d8 $E2                                         ; JR      082E
...
________0870:   #d8 $48, $30                                    ; RAL 
________0872:   #d8 $3C                                         ; STAX    D+
________0873:   #d8 $52                                         ; DCR     B
________0874:   #d8 $FA                                         ; JR      086F
...
________088C:   #d8 $2D                                         ; LDAX    H+
________088D:   #d8 $70, $FC                                    ; EQAX    D+
________088F:   #d8 $4F, $34                                    ; JRE     07C5
________0891:   #d8 $52                                         ; DCR     B
________0892:   #d8 $F9                                         ; JR      088C
...
________089C:   #d8 $F9                                         ; JR      0896
;End of Puzzle Code
;------------------------------------------------------------
;Clear A
CALT_85_089D:   #d8 $69, $00                                    ; MVI     A,00
________089F:   #d8 $08                                         ; RET
;------------------------------------------------------------
;XCHG HL,DE
CALT_94_08A0:   #d8 $48, $3E                                    ; PUSH    H
________08A2:   #d8 $48, $2E                                    ; PUSH    D
________08A4:   #d8 $48, $3F                                    ; POP     H
________08A6:   #d8 $48, $2F                                    ; POP     D
________08A8:   #d8 $08                                         ; RET
;------------------------------------------------------------
;Music-playing code...
CALF____08A9:   #d8 $2D                                         ; LDAX    H+
________08AA:   #d8 $1A                                         ; MOV     B,A
________08AB:   #d8 $2D                                         ; LDAX    H+
________08AC:   #d8 $38, $99                                    ; STAW    99
________08AE:   #d8 $70, $3E, $84, $FF                          ; SHLD    FF84
________08B2:   #d8 $0A                                         ; MOV     A,B
________08B3:   #d8 $41                                         ; INR     A
________08B4:   #d8 $C1                                         ; JR      08B6
________08B5:   #d8 $18                                         ; RETS                ;Return & Skip if read "$FF"

;Move "note" into TM0
CALF____08B6:   #d8 $34, $78, $02                               ; LXI     H,0278           ;Table Start
________08B9:   #d8 $0A                                         ; MOV     A,B
________08BA:   #d8 $36, $01                                    ; SUINB   A,01
________08BC:   #d8 $C3                                         ; JR      08C0
________08BD:   #d8 $32                                         ; INX     H          ;Add A*2 to HL (wastefully)
________08BE:   #d8 $32                                         ; INX     H
________08BF:   #d8 $FA                                         ; JR      08BA

________08C0:   #d8 $2D                                         ; LDAX    H+
________08C1:   #d8 $4D, $C6                                    ; MOV     T0,A
________08C3:   #d8 $2B                                         ; LDAX    H
________08C4:   #d8 $38, $9A                                    ; STAW    9A
________08C6:   #d8 $38, $8F                                    ; STAW    8F
________08C8:   #d8 $52                                         ; DCR     B
________08C9:   #d8 $69, $00                                    ; MVI     A,00       ;Sound?
________08CB:   #d8 $69, $03                                    ; MVI     A,03       ;Silent
________08CD:   #d8 $4D, $C9                                    ; MOV     TMM,A
________08CF:   #d8 $15, $80, $01                               ; ORIW    80,01
________08D2:   #d8 $19                                         ; STM
________08D3:   #d8 $08                                         ; RET
;------------------------------------------------------------
;Load a "multiplication table" for A,E from (HL) and do AxE
;Is this ever used?
________08D4:   #d8 $2D                                         ; LDAX    H+
________08D5:   #d8 $1D                                         ; MOV     E,A
________08D6:   #d8 $2B                                         ; LDAX    H
;HL <== AxE
CALT_93_08D7:   #d8 $34, $00, $00                               ; LXI     H,0000
________08DA:   #d8 $6C, $00                                    ; MVI     D,00
________08DC:   #d8 $27, $00                                    ; GTI     A,00
________08DE:   #d8 $08                                         ; RET
________08DF:   #d8 $48, $2A                                    ; CLC
...
________08EC:   #d8 $0C                                         ; MOV     A,D
________08ED:   #d8 $48, $30                                    ; RAL
________08EF:   #d8 $1C                                         ; MOV     D,A
________08F0:   #d8 $48, $0F                                    ; POP     V
________08F2:   #d8 $E9                                         ; JR      08DC
;-----------------------------
;((HL+) <==> (DE+))xB
;This function swaps the contents of (HL)<->(DE) B times
CALT_97_08F3:   #d8 $78, $F8                                    ; CALF    08F8	;Swap (HL+)<->(DE+)
________08F5:   #d8 $52                                         ; DCR     B
________08F6:   #d8 $FC                                         ; JR      08F3
________08F7:   #d8 $08                                         ; RET
;------------------------------------------------------------
;Swap (HL+)<->(DE+)
CALF____08F8:   #d8 $2B                                         ; LDAX    H
________08F9:   #d8 $1B                                         ; MOV     C,A
________08FA:   #d8 $2A                                         ; LDAX    D
________08FB:   #d8 $3D                                         ; STAX    H+
________08FC:   #d8 $0B                                         ; MOV     A,C
________08FD:   #d8 $3C                                         ; STAX    D+
________08FE:   #d8 $08                                         ; RET
;------------------------------------------------------------
;Clear Screen 2 RAM
...
________090B:   #d8 $FB                                         ; JR      0907
________090C:   #d8 $08                                         ; RET
;------------------------------------------------------------
;Clear C594~C7FF
CALT_89_090D:   #d8 $34, $94, $C5                               ; LXI     H,C594	;Set HL
________0910:   #d8 $79, $05                                    ; CALF    0905	;And jump to above routine
________0912:   #d8 $6A, $13                                    ; MVI     B,13        ;Then clear $14 more bytes
________0914:   #d8 $C5                                         ; JR      091A	;Clear RAM (HL+)xB
...
________091D:   #d8 $FD                                         ; JR      091B
________091E:   #d8 $08                                         ; RET
;------------------------------------------------------------
...
________092F:   #d8 $1B                                         ; MOV     C,A
________0930:   #d8 $6A, $40                                    ; MVI     B,40	;Debouncing delay
________0932:   #d8 $52                                         ; DCR     B
________0933:   #d8 $FE                                         ; JR      0932
________0934:   #d8 $4C, $C2                                    ; MOV     A,PC	;Get port C a 2nd time
________0936:   #d8 $16, $FF                                    ; XRI     A,FF
________0938:   #d8 $60, $FB                                    ; EQA     A,C		;Check if both reads are equal
________093A:   #d8 $F4                                         ; JR      092F
________093B:   #d8 $64, $98, $40                               ; ORI     PA,40	;PA Bit 6 on
________093E:   #d8 $07, $03                                    ; ANI     A,03
________0940:   #d8 $3C                                         ; STAX    D+		;Save controller read in 92
________0941:   #d8 $0B                                         ; MOV     A,C
________0942:   #d8 $7C, $72                                    ; CALF    0C72	;RLR A x2
________0944:   #d8 $07, $07                                    ; ANI     A,07
________0946:   #d8 $3E                                         ; STAX    D-		;Save cont in 93
________0947:   #d8 $64, $88, $7F                               ; ANI     PA,7F	;PA bit 7 off
________094A:   #d8 $4C, $C2                                    ; MOV     A,PC	;Get other controller bits
________094C:   #d8 $16, $FF                                    ; XRI     A,FF
________094E:   #d8 $1B                                         ; MOV     C,A
________094F:   #d8 $6A, $40                                    ; MVI     B,40	;...and debounce
________0951:   #d8 $52                                         ; DCR     B
________0952:   #d8 $FE                                         ; JR      0951
________0953:   #d8 $4C, $C2                                    ; MOV     A,PC
________0955:   #d8 $16, $FF                                    ; XRI     A,FF
________0957:   #d8 $60, $FB                                    ; EQA     A,C		;...check again
________0959:   #d8 $F4                                         ; JR      094E
________095A:   #d8 $64, $98, $80                               ; ORI     PA,80       ;PA bit 7 on
________095D:   #d8 $48, $30                                    ; RAL
________095F:   #d8 $48, $30                                    ; RAL
________0961:   #d8 $07, $0C                                    ; ANI     A,0C
________0963:   #d8 $70, $9A                                    ; ORAX    D		;Or with FF92
________0965:   #d8 $3C                                         ; STAX    D+          ;...and save
________0966:   #d8 $0B                                         ; MOV     A,C
________0967:   #d8 $48, $30                                    ; RAL 
________0969:   #d8 $07, $38                                    ; ANI     A,38
________096B:   #d8 $70, $9A                                    ; ORAX    D           ;Or with FF93
________096D:   #d8 $3E                                         ; STAX    D-		;...and save
________096E:   #d8 $34, $90, $FF                               ; LXI     H,FF90      ;Get our new,old
________0971:   #d8 $14, $94, $FF                               ; LXI     B,FF94
________0974:   #d8 $2D                                         ; LDAX    H+          ;And XOR to get controller strobe
________0975:   #d8 $70, $94                                    ; XRAX    D+		;But this strobe function is stupid:
________0977:   #d8 $39                                         ; STAX    B           ;Bits go to 1 whenever the button is
________0978:   #d8 $12                                         ; INX     B		;initially pressed AND released...
________0979:   #d8 $2B                                         ; LDAX    H
________097A:   #d8 $70, $92                                    ; XRAX    D
________097C:   #d8 $39                                         ; STAX    B
________097D:   #d8 $08                                         ; RET
;------------------------------------------------------------
;C258+ ==> C000+
CALT_90_097E:   #d8 $7E, $5E                                    ; CALF    0E5E
________0980:   #d8 $C3                                         ; JR      0984
;C000+ ==> C258+
...
________098A:   #d8 $FB                                         ; JR      0986
________098B:   #d8 $08                                         ; RET     
;------------------------------------------------------------
;Swap C258+ <==> C000+
...
________0997:   #d8 $F9                                         ; JR      0991
________0998:   #d8 $08                                         ; RET
;------------------------------------------------------------
;Set Dot; B,C = X-,Y-position
;(Oddly enough, this writes dots to the 2nd screen RAM area!)
CALT_98_0999:   #d8 $48, $1E                                    ; PUSH    B
________099B:   #d8 $7B, $F4                                    ; CALF    0BF4       ;Point to 2nd screen
________099D:   #d8 $48, $1F                                    ; POP     B
...
________09A9:   #d8 $FC                                         ; JR      09A6
________09AA:   #d8 $70, $9B                                    ; ORAX    H
________09AC:   #d8 $D8                                         ; JR      09C5
;------------------------------------------------------------
CALF____09AD:   #d8 $75, $D8, $00                               ; EQIW    D8,00       ;"Invert Dot", then...
________09B0:   #d8 $E8                                         ; JR      0999

;Clear Dot; B,C = X-,Y-position
CALT_AD_09B1:   #d8 $48, $1E                                    ; PUSH    B
________09B3:   #d8 $7B, $F4                                    ; CALF    0BF4        ;Point to 2nd screen
________09B5:   #d8 $48, $1F                                    ; POP     B
________09B7:   #d8 $0B                                         ; MOV     A,C
________09B8:   #d8 $07, $07                                    ; ANI     A,07
________09BA:   #d8 $1B                                         ; MOV     C,A
________09BB:   #d8 $69, $FF                                    ; MVI     A,FF
________09BD:   #d8 $48, $2A                                    ; CLC
________09BF:   #d8 $48, $30                                    ; RAL
________09C1:   #d8 $53                                         ; DCR     C
________09C2:   #d8 $FC                                         ; JR      09BF
________09C3:   #d8 $70, $8B                                    ; ANAX    H
________09C5:   #d8 $3B                                         ; STAX    H
________09C6:   #d8 $08                                         ; RET
;------------------------------------------------------------
...
CALT_99_09C7:   #d8 $48, $2F                                    ; POP     D
________09C9:   #d8 $2C                                         ; LDAX    D+  	;SP+1
________09CA:   #d8 $1B                                         ; MOV     C,A
________09CB:   #d8 $2C                                         ; LDAX    D+		;SP+2
________09CC:   #d8 $48, $2E                                    ; PUSH    D
________09CE:   #d8 $1C                                         ; MOV     D,A
________09CF:   #d8 $07, $7F                                    ; ANI     A,7F
________09D1:   #d8 $1A                                         ; MOV     B,A
________09D2:   #d8 $0C                                         ; MOV     A,D
________09D3:   #d8 $47, $80                                    ; ONI     A,80
________09D5:   #d8 $C7                                         ; JR      09DD

________09D6:   #d8 $2B                                         ; LDAX    H
________09D7:   #d8 $60, $8B                                    ; ANA     A,C
________09D9:   #d8 $3D                                         ; STAX    H+
________09DA:   #d8 $52                                         ; DCR     B
________09DB:   #d8 $FA                                         ; JR      09D6
________09DC:   #d8 $08                                         ; RET

________09DD:   #d8 $2B                                         ; LDAX    H
________09DE:   #d8 $60, $9B                                    ; ORA     A,C
________09E0:   #d8 $3D                                         ; STAX    H+
________09E1:   #d8 $52                                         ; DCR     B
________09E2:   #d8 $FA                                         ; JR      09DD
________09E3:   #d8 $08                                         ; RET
;------------------------------------------------------------
...
;
CALT_9A_09E4:   #d8 $48, $2F                                    ; POP     D
________09E6:   #d8 $2C                                         ; LDAX    D+
________09E7:   #d8 $1A                                         ; MOV     B,A
________09E8:   #d8 $38, $9B                                    ; STAW    9B
________09EA:   #d8 $2C                                         ; LDAX    D+
________09EB:   #d8 $1B                                         ; MOV     C,A
________09EC:   #d8 $07, $07                                    ; ANI     A,07
________09EE:   #d8 $38, $9C                                    ; STAW    9C
________09F0:   #d8 $2C                                         ; LDAX    D+
________09F1:   #d8 $48, $2E                                    ; PUSH    D
________09F3:   #d8 $38, $9D                                    ; STAW    9D
________09F5:   #d8 $07, $07                                    ; ANI     A,07
________09F7:   #d8 $41                                         ; INR     A
________09F8:   #d8 $48, $1E                                    ; PUSH    B
________09FA:   #d8 $38, $98                                    ; STAW    98
________09FC:   #d8 $24, $A8, $FF                               ; LXI     D,FFA8
________09FF:   #d8 $70, $2E, $C0, $FF                          ; SDED    FFC0
________0A03:   #d8 $1A                                         ; MOV     B,A
...
________0A0E:   #d8 $CA                                         ; JR      0A19
________0A0F:   #d8 $52                                         ; DCR     B
________0A10:   #d8 $C1                                         ; JR      0A12
________0A11:   #d8 $D1                                         ; JR      0A23
...
;
CALT_9B_0A29:   #d8 $48, $2F                                    ; POP     D
________0A2B:   #d8 $2C                                         ; LDAX    D+
________0A2C:   #d8 $1A                                         ; MOV     B,A
________0A2D:   #d8 $38, $9B                                    ; STAW    9B
________0A2F:   #d8 $2C                                         ; LDAX    D+
________0A30:   #d8 $1B                                         ; MOV     C,A         ;Save X,Y position in BC
________0A31:   #d8 $07, $07                                    ; ANI     A,07
________0A33:   #d8 $38, $9C                                    ; STAW    9C
________0A35:   #d8 $2C                                         ; LDAX    D+
________0A36:   #d8 $48, $2E                                    ; PUSH    D
...
________0A46:   #d8 $C2                                         ; JR      0A49
________0A47:   #d8 $9D                                         ; CALT    00BA	; "Set HL to screen (B,C)"
________0A48:   #d8 $C2                                         ; JR      0A4B
...
________0A64:   #d8 $C1                                         ; JR      0A66
________0A65:   #d8 $08                                         ; RET

________0A66:   #d8 $45, $C6, $FF                               ; ONIW    C6,FF
________0A69:   #d8 $DB                                         ; JR      0A85
...
________0A77:   #d8 $7B, $D3                                    ; CALF    0BD3
________0A79:   #d8 $57, $80                                    ; OFFI    A,80
________0A7B:   #d8 $C9                                         ; JR      0A85
...
________0A92:   #d8 $7B, $D3                                    ; CALF    0BD3	;Copy B*A bytes?
________0A94:   #d8 $57, $80                                    ; OFFI    A,80
________0A96:   #d8 $C9                                         ; JR      0AA0
...
________0AA6:   #d8 $C1                                         ; JR      0AA8
________0AA7:   #d8 $C5                                         ; JR      0AAD

________0AA8:   #d8 $48, $2B                                    ; STC
________0AAA:   #d8 $48, $30                                    ; RAL
________0AAC:   #d8 $F8                                         ; JR      0AA5

________0AAD:   #d8 $48, $0E                                    ; PUSH    V
________0AAF:   #d8 $1B                                         ; MOV     C,A
________0AB0:   #d8 $7E, $6A                                    ; CALF    0E6A	;(FFB0 -> HL)
...
________0AB9:   #d8 $FA                                         ; JR      0AB4
________0ABA:   #d8 $48, $0F                                    ; POP     V
________0ABC:   #d8 $16, $FF                                    ; XRI     A,FF
________0ABE:   #d8 $1B                                         ; MOV     C,A
...
________0ADC:   #d8 $7C, $31                                    ; CALF    0C31	;Roll graphics a bit (shift up/dn)
________0ADE:   #d8 $45, $C6, $FF                               ; ONIW    C6,FF
________0AE1:   #d8 $CD                                         ; JR      0AEF
________0AE2:   #d8 $70, $2F, $C7, $FF                          ; LDED    FFC7
________0AE6:   #d8 $7E, $6A                                    ; CALF    0E6A	;(FFB0 -> HL)
________0AE8:   #d8 $6A, $04                                    ; MVI     B,04
________0AEA:   #d8 $15, $80, $10                               ; ORIW    80,10
________0AED:   #d8 $7B, $D3                                    ; CALF    0BD3	;Copy B*A bytes?
________0AEF:   #d8 $55, $C6, $08                               ; OFFIW   C6,08
________0AF2:   #d8 $CE                                         ; JR      0B01
...
________0B97:   #d8 $48, $3E                                    ; PUSH    H
________0B99:   #d8 $7E, $6A                                    ; CALF    0E6A
________0B9B:   #d8 $24, $C0, $FF                               ; LXI     D,FFC0
________0B9E:   #d8 $6A, $0F                                    ; MVI     B,0F
________0BA0:   #d8 $2B                                         ; LDAX    H
________0BA1:   #d8 $70, $94                                    ; XRAX    D+
________0BA3:   #d8 $3D                                         ; STAX    H+
________0BA4:   #d8 $52                                         ; DCR     B
________0BA5:   #d8 $FA                                         ; JR      0BA0
________0BA6:   #d8 $48, $3F                                    ; POP     H
________0BA8:   #d8 $15, $80, $08                               ; ORIW    80,08
________0BAB:   #d8 $24, $B0, $FF                               ; LXI     D,FFB0
________0BAE:   #d8 $14, $B8, $FF                               ; LXI     B,FFB8
________0BB1:   #d8 $7C, $2F                                    ; CALF    0C2F
________0BB3:   #d8 $70, $2F, $9E, $FF                          ; LDED    FF9E
________0BB7:   #d8 $0C                                         ; MOV     A,D
________0BB8:   #d8 $47, $40                                    ; ONI     A,40
________0BBA:   #d8 $C7                                         ; JR      0BC2
________0BBB:   #d8 $7E, $6A                                    ; CALF    0E6A
...
________0BD7:   #d8 $CA                                         ; JR      0BE2
________0BD8:   #d8 $37, $4B                                    ; LTI     A,4B
________0BDA:   #d8 $D2                                         ; JR      0BED
________0BDB:   #d8 $48, $0E                                    ; PUSH    V
________0BDD:   #d8 $2D                                         ; LDAX    H+
________0BDE:   #d8 $3C                                         ; STAX    D+
________0BDF:   #d8 $48, $0F                                    ; POP     V
________0BE1:   #d8 $C7                                         ; JR      0BE9
________0BE2:   #d8 $45, $80, $10                               ; ONIW    80,10
________0BE5:   #d8 $C2                                         ; JR      0BE8
________0BE6:   #d8 $32                                         ; INX     H
________0BE7:   #d8 $C1                                         ; JR      0BE9

________0BE8:   #d8 $22                                         ; INX     D
________0BE9:   #d8 $41                                         ; INR     A
________0BEA:   #d8 $00                                         ; NOP
________0BEB:   #d8 $52                                         ; DCR     B
________0BEC:   #d8 $E8                                         ; JR      0BD5
________0BED:   #d8 $05, $80, $EF                               ; ANIW    80,EF
________0BF0:   #d8 $08                                         ; RET
;------------------------------------------------------------
...
________0BF9:   #d8 $0B                                         ; MOV     A,C
________0BFA:   #d8 $6B, $00                                    ; MVI     C,00
________0BFC:   #d8 $46, $08                                    ; ADI     A,08
________0BFE:   #d8 $36, $08                                    ; SUINB   A,08
________0C00:   #d8 $C7                                         ; JR      0C08
________0C01:   #d8 $48, $0E                                    ; PUSH    V
________0C03:   #d8 $8D                                         ; CALT    009A	; "HL <== HL+E"
________0C04:   #d8 $48, $0F                                    ; POP     V
________0C06:   #d8 $43                                         ; INR     C
________0C07:   #d8 $F6                                         ; JR      0BFE
________0C08:   #d8 $0A                                         ; MOV     A,B
________0C09:   #d8 $57, $80                                    ; OFFI    A,80
________0C0B:   #d8 $08                                         ; RET     
________0C0C:   #d8 $1D                                         ; MOV     E,A
________0C0D:   #d8 $CA                                         ; JR      0C18
;------------------------------------------------------------
;[PC+1] HL +- byte
CALT_8C_0C0E:   #d8 $48, $2F                                    ; POP     D
________0C10:   #d8 $2C                                         ; LDAX    D+          ;Get byte after PC
________0C11:   #d8 $48, $2E                                    ; PUSH    D
________0C13:   #d8 $1D                                         ; MOV     E,A
________0C14:   #d8 $37, $80                                    ; LTI     A,80	;Add or subtract that byte
________0C16:   #d8 $69, $FF                                    ; MVI     A,FF
;HL <== HL+E
CALT_8D_0C18:   #d8 $69, $00                                    ; MVI     A,00
________0C1A:   #d8 $1C                                         ; MOV     D,A
;HL <== HL+DE
CALT_8B_0C1B:   #d8 $0D                                         ; MOV     A,E
________0C1C:   #d8 $60, $C7                                    ; ADD     A,L
________0C1E:   #d8 $1F                                         ; MOV     L,A
________0C1F:   #d8 $0C                                         ; MOV     A,D
________0C20:   #d8 $60, $D6                                    ; ADC     A,H
________0C22:   #d8 $1E                                         ; MOV     H,A
________0C23:   #d8 $08                                         ; RET
;------------------------------------------------------------
;HL=C4B0+(A*$10)
CALT_9E_0C24:   #d8 $34, $B0, $C4                               ; LXI     H,C4B0
________0C27:   #d8 $6D, $10                                    ; MVI     E,10
________0C29:   #d8 $1A                                         ; MOV     B,A
________0C2A:   #d8 $52                                         ; DCR     B
________0C2B:   #d8 $C1                                         ; JR      0C2D
________0C2C:   #d8 $08                                         ; RET

________0C2D:   #d8 $8D                                         ; CALT    009A	; "HL <== HL+E"
________0C2E:   #d8 $FB                                         ; JR      0C2A
;------------------------------------------------------------
...
________0C37:   #d8 $48, $1E                                    ; PUSH    B
________0C39:   #d8 $6B, $00                                    ; MVI     C,00
________0C3B:   #d8 $2D                                         ; LDAX    H+
________0C3C:   #d8 $30, $97                                    ; DCRW    97
________0C3E:   #d8 $C1                                         ; JR      0C40
________0C3F:   #d8 $CD                                         ; JR      0C4D

________0C40:   #d8 $48, $2A                                    ; CLC
________0C42:   #d8 $48, $30                                    ; RAL
________0C44:   #d8 $48, $0E                                    ; PUSH    V
________0C46:   #d8 $0B                                         ; MOV     A,C
________0C47:   #d8 $48, $30                                    ; RAL
________0C49:   #d8 $1B                                         ; MOV     C,A
________0C4A:   #d8 $48, $0F                                    ; POP     V
________0C4C:   #d8 $EF                                         ; JR      0C3C

________0C4D:   #d8 $45, $80, $08                               ; ONIW    80,08
________0C50:   #d8 $C3                                         ; JR      0C54
________0C51:   #d8 $70, $9A                                    ; ORAX    D
________0C53:   #d8 $C2                                         ; JR      0C56

________0C54:   #d8 $70, $8A                                    ; ANAX    D
________0C56:   #d8 $3A                                         ; STAX    D
________0C57:   #d8 $0B                                         ; MOV     A,C
________0C58:   #d8 $48, $1F                                    ; POP     B
________0C5A:   #d8 $45, $80, $08                               ; ONIW    80,08
________0C5D:   #d8 $C3                                         ; JR      0C61
________0C5E:   #d8 $70, $99                                    ; ORAX    B
________0C60:   #d8 $C2                                         ; JR      0C63

________0C61:   #d8 $70, $89                                    ; ANAX    B
________0C63:   #d8 $39                                         ; STAX    B
________0C64:   #d8 $12                                         ; INX     B
________0C65:   #d8 $22                                         ; INX     D
________0C66:   #d8 $30, $96                                    ; DCRW    96
________0C68:   #d8 $4F, $C9                                    ; JRE     0C33
________0C6A:   #d8 $05, $80, $F7                               ; ANIW    80,F7
________0C6D:   #d8 $08                                         ; RET
;------------------------------------------------------------
...
________0C9F:   #d8 $48, $30                                    ; RAL
________0CA1:   #d8 $3D                                         ; STAX    H+
________0CA2:   #d8 $52                                         ; DCR     B
________0CA3:   #d8 $FA                                         ; JR      0C9E
________0CA4:   #d8 $20, $83                                    ; INRW    83
________0CA6:   #d8 $48, $3F                                    ; POP     H
________0CA8:   #d8 $75, $83, $0D                               ; EQIW    83,0D
________0CAB:   #d8 $4F, $DB                                    ; JRE     0C88
...
________0CF1:   #d8 $C4                                         ; JR      0CF6
________0CF2:   #d8 $34, $A3, $FF                               ; LXI     H,FFA3
________0CF5:   #d8 $D6                                         ; JR      0D0C

________0CF6:   #d8 $70, $3F, $D6, $FF                          ; LHLD    FFD6
________0CFA:   #d8 $2D                                         ; LDAX    H+
________0CFB:   #d8 $67, $FF                                    ; NEI     A,FF	;If terminator...
________0CFD:   #d8 $E0                                         ; JR      0CDE	;...reset scroll
...
________0DD2:   #d8 $08                                         ; RET
;------------------------------------------------------------
________0DD3:   #d8 $67, $01                                    ; NEI     A,01
________0DD5:   #d8 $D8                                         ; JR      0DEE
________0DD6:   #d8 $67, $04                                    ; NEI     A,04
________0DD8:   #d8 $4E, $22                                    ; JRE     0DFC
________0DDA:   #d8 $67, $02                                    ; NEI     A,02
________0DDC:   #d8 $4E, $2C                                    ; JRE     0E0A

________0DDE:   #d8 $70, $69, $FF, $C7                          ; MOV     A,C7FF   	;More puzzle grid drawing, probably...
________0DE2:   #d8 $07, $03                                    ; ANI     A,03
________0DE4:   #d8 $67, $01                                    ; NEI     A,01
________0DE6:   #d8 $18                                         ; RETS

________0DE7:   #d8 $14, $FF, $12                               ; LXI     B,12FF
________0DEA:   #d8 $15, $A2, $FF                               ; ORIW    A2,FF
________0DED:   #d8 $CD                                         ; JR      0DFB
;------------------------------------------------------------
________0DEE:   #d8 $70, $69, $FF, $C7                          ; MOV     A,C7FF
________0DF2:   #d8 $37, $09                                    ; LTI     A,09
________0DF4:   #d8 $18                                         ; RETS

________0DF5:   #d8 $14, $04, $0D                               ; LXI     B,0D04
________0DF8:   #d8 $05, $A2, $00                               ; ANIW    A2,00
________0DFB:   #d8 $DB                                         ; JR      0E17
;------------------------------------------------------------
________0DFC:   #d8 $70, $69, $FF, $C7                          ; MOV     A,C7FF
________0E00:   #d8 $27, $04                                    ; GTI     A,04
________0E02:   #d8 $18                                         ; RETS
________0E03:   #d8 $14, $FC, $0F                               ; LXI     B,0FFC
________0E06:   #d8 $05, $A2, $00                               ; ANIW    A2,00
________0E09:   #d8 $CD                                         ; JR      0E17
;------------------------------------------------------------
________0E0A:   #d8 $70, $69, $FF, $C7                          ; MOV     A,C7FF
________0E0E:   #d8 $47, $03                                    ; ONI     A,03
________0E10:   #d8 $18                                         ; RETS

________0E11:   #d8 $14, $01, $11                               ; LXI     B,1101
________0E14:   #d8 $15, $A2, $FF                               ; ORIW    A2,FF
________0E17:   #d8 $70, $69, $FF, $C7                          ; MOV     A,C7FF
________0E1B:   #d8 $1D                                         ; MOV     E,A
________0E1C:   #d8 $70, $79, $FE, $C7                          ; MOV     C7FE,A
________0E20:   #d8 $60, $C3                                    ; ADD     A,C
________0E22:   #d8 $1C                                         ; MOV     D,A
________0E23:   #d8 $70, $79, $FF, $C7                          ; MOV     C7FF,A
________0E27:   #d8 $34, $F1, $C7                               ; LXI     H,C7F1
________0E2A:   #d8 $0C                                         ; MOV     A,D
________0E2B:   #d8 $51                                         ; DCR     A
________0E2C:   #d8 $C1                                         ; JR      0E2E
________0E2D:   #d8 $C2                                         ; JR      0E30

________0E2E:   #d8 $32                                         ; INX     H
________0E2F:   #d8 $FB                                         ; JR      0E2B

________0E30:   #d8 $0D                                         ; MOV     A,E
________0E31:   #d8 $24, $F1, $C7                               ; LXI     D,C7F1
________0E34:   #d8 $51                                         ; DCR     A
________0E35:   #d8 $C3                                         ; JR      0E39
________0E36:   #d8 $54, $F8, $08                               ; JMP     08F8

________0E39:   #d8 $22                                         ; INX     D
________0E3A:   #d8 $F9                                         ; JR      0E34
;------------------------------------------------------------
...
________0E4C:   #d8 $08                                         ; RET
;------------------------------------------------------------
; Turns on a hardware timer
CALF____0E4D:   #d8 $48, $24                                    ; DI
________0E4F:   #d8 $69, $07                                    ; MVI     A,07
________0E51:   #d8 $4D, $C9                                    ; MOV     TMM,A
________0E53:   #d8 $69, $74                                    ; MVI     A,74
________0E55:   #d8 $4D, $C6                                    ; MOV     T0,A
________0E57:   #d8 $05, $80, $FC                               ; ANIW    80,FC
________0E5A:   #d8 $19                                         ; STM
________0E5B:   #d8 $48, $20                                    ; EI
________0E5D:   #d8 $08                                         ; RET
;------------------------------------------------------------
...
________0E7C:   #d8 $7E, $6A                                    ; CALF    0E6A	;(FFB0->HL)
________0E7E:   #d8 $2A                                         ; LDAX    D  		;In this loop, the byte at (FFB0)
________0E7F:   #d8 $48, $30                                    ; RAL			;Has its bits split up into 8 bytes
________0E81:   #d8 $48, $0E                                    ; PUSH    V		;And this loop runs 8 times...
________0E83:   #d8 $2B                                         ; LDAX    H
________0E84:   #d8 $48, $31                                    ; RLR
________0E86:   #d8 $3D                                         ; STAX    H+
________0E87:   #d8 $48, $0F                                    ; POP     V
________0E89:   #d8 $53                                         ; DCR     C
________0E8A:   #d8 $F4                                         ; JR      0E7F
________0E8B:   #d8 $22                                         ; INX     D
________0E8C:   #d8 $52                                         ; DCR     B
________0E8D:   #d8 $EC                                         ; JR      0E7A

________0E8E:   #d8 $48, $2E                                    ; PUSH    D
...
________0E97:   #d8 $08                                         ; RET
;------------------------------------------------------------
;[PC+1] ?? (Unpack & Roll 8 bits)
CALT_A9_0E98:   #d8 $48, $3F                                    ; POP     H
________0E9A:   #d8 $2D                                         ; LDAX    H+
________0E9B:   #d8 $48, $3E                                    ; PUSH    H
________0E9D:   #d8 $48, $0E                                    ; PUSH    V
________0E9F:   #d8 $7E, $73                                    ; CALF    0E73
________0EA1:   #d8 $48, $0F                                    ; POP     V
________0EA3:   #d8 $C5                                         ; JR      0EA9
;-----------------------------------------------------------
...
________0EB4:   #d8 $2A                                         ; LDAX    D
________0EB5:   #d8 $48, $30                                    ; RAL 
________0EB7:   #d8 $48, $0E                                    ; PUSH    V
________0EB9:   #d8 $2B                                         ; LDAX    H
________0EBA:   #d8 $48, $31                                    ; RLR
________0EBC:   #d8 $3B                                         ; STAX    H
________0EBD:   #d8 $48, $0F                                    ; POP     V
________0EBF:   #d8 $52                                         ; DCR     B
________0EC0:   #d8 $F4                                         ; JR      0EB5
________0EC1:   #d8 $33                                         ; DCX     H
________0EC2:   #d8 $22                                         ; INX     D
________0EC3:   #d8 $53                                         ; DCR     C
________0EC4:   #d8 $ED                                         ; JR      0EB2
________0EC5:   #d8 $48, $2F                                    ; POP     D
________0EC7:   #d8 $34, $B8, $FF                               ; LXI     H,FFB8
________0ECA:   #d8 $7E, $CE                                    ; CALF    0ECE
________0ECC:   #d8 $7E, $6A                                    ; CALF    0E6A

CALF____0ECE:   #d8 $6A, $07                                    ; MVI     B,8-1
________0ED0:   #d8 $95                                         ; CALT    00AA	; "((HL+) ==> (DE+))xB"
________0ED1:   #d8 $08                                         ; RET     
;------------------------------------------------------------
;[PC+x] ?? (Add/Sub multiple bytes)
CALT_AB_0ED2:   #d8 $48, $3F                                    ; POP     H
________0ED4:   #d8 $2D                                         ; LDAX    H+
________0ED5:   #d8 $48, $3E                                    ; PUSH    H
________0ED7:   #d8 $1A                                         ; MOV     B,A
...
________0EE2:   #d8 $08                                         ; RET     
________0EE3:   #d8 $38, $97                                    ; STAW    97
________0EE5:   #d8 $30, $97                                    ; DCRW    97
________0EE7:   #d8 $C8                                         ; JR      0EF0        ;Based on 97, jump to cart (4007)!
...
________0EF0:   #d8 $48, $3F                                    ; POP     H
________0EF2:   #d8 $2D                                         ; LDAX    H+
________0EF3:   #d8 $48, $3E                                    ; PUSH    H
________0EF5:   #d8 $38, $98                                    ; STAW    98
________0EF7:   #d8 $07, $0F                                    ; ANI     A,0F
________0EF9:   #d8 $37, $0C                                    ; LTI     A,0C
________0EFB:   #d8 $E9                                         ; JR      0EE5
...
________0F03:   #d8 $FB                                         ; JR      0EFF
________0F04:   #d8 $24, $96, $FF                               ; LXI     D,FF96
________0F07:   #d8 $45, $98, $80                               ; ONIW    98,80
________0F0A:   #d8 $C5                                         ; JR      0F10
________0F0B:   #d8 $2B                                         ; LDAX    H
________0F0C:   #d8 $70, $E2                                    ; SUBX    D
________0F0E:   #d8 $3B                                         ; STAX    H
________0F0F:   #d8 $C8                                         ; JR      0F18

________0F10:   #d8 $45, $98, $40                               ; ONIW    98,40
________0F13:   #d8 $C4                                         ; JR      0F18
________0F14:   #d8 $2B                                         ; LDAX    H
________0F15:   #d8 $70, $C2                                    ; ADDX    D
________0F17:   #d8 $3B                                         ; STAX    H
________0F18:   #d8 $33                                         ; DCX     H
________0F19:   #d8 $45, $98, $10                               ; ONIW    98,10
________0F1C:   #d8 $C6                                         ; JR      0F23

________0F1D:   #d8 $2B                                         ; LDAX    H
________0F1E:   #d8 $70, $C2                                    ; ADDX    D
________0F20:   #d8 $3B                                         ; STAX    H
________0F21:   #d8 $4F, $C2                                    ; JRE     0EE5

________0F23:   #d8 $45, $98, $20                               ; ONIW    98,20
________0F26:   #d8 $FA                                         ; JR      0F21
________0F27:   #d8 $2B                                         ; LDAX    H
________0F28:   #d8 $70, $E2                                    ; SUBX    D
________0F2A:   #d8 $3B                                         ; STAX    H
________0F2B:   #d8 $F5                                         ; JR      0F21
;------------------------------------------------------------
...
________0F36:   #d8 $7F, $3B                                    ; CALF    0F3B
________0F38:   #d8 $53                                         ; DCR     C
________0F39:   #d8 $FA                                         ; JR      0F34
________0F3A:   #d8 $08                                         ; RET
;------------------------------------------------------------
;Invert bytes xB
CALF____0F3B:   #d8 $2B                                         ; LDAX    H
________0F3C:   #d8 $16, $FF                                    ; XRI     A,FF
________0F3E:   #d8 $3D                                         ; STAX    H+
________0F3F:   #d8 $52                                         ; DCR     B
________0F40:   #d8 $FA                                         ; JR      0F3B
________0F41:   #d8 $08                                         ; RET
;------------------------------------------------------------
;[PC+1] Invert 8 bytes at (C4B8+A*$10)
CALT_A5_0F42:   #d8 $48, $3F                                    ; POP     H
________0F44:   #d8 $2D                                         ; LDAX    H+
________0F45:   #d8 $48, $3E                                    ; PUSH    H
________0F47:   #d8 $37, $0C                                    ; LTI     A,0C
________0F49:   #d8 $08                                         ; RET
...
CALT_A4_0F5D:   #d8 $48, $1F                                    ; POP     B
________0F5F:   #d8 $29                                         ; LDAX    B
________0F60:   #d8 $12                                         ; INX     B
________0F61:   #d8 $48, $1E                                    ; PUSH    B
...
________0F6C:   #d8 $E4                                         ; JR      0F51

________0F6D:   #d8 $7C, $72                                    ; CALF    0C72	;"RLR A" x2
________0F6F:   #d8 $1A                                         ; MOV     B,A		;Get our length bits (8-32 bits)
________0F70:   #d8 $07, $03                                    ; ANI     A,03
________0F72:   #d8 $1B                                         ; MOV     C,A
________0F73:   #d8 $0A                                         ; MOV     A,B
________0F74:   #d8 $7C, $72                                    ; CALF    0C72        ;"RLR A" x2
________0F76:   #d8 $07, $03                                    ; ANI     A,03
________0F78:   #d8 $1A                                         ; MOV     B,A
________0F79:   #d8 $45, $96, $40                               ; ONIW    96,40	;Do we subtract instead of add?
________0F7C:   #d8 $C6                                         ; JR      0F83
________0F7D:   #d8 $45, $96, $80                               ; ONIW    96,80	;Do we work in binary-coded decimal?
________0F80:   #d8 $D8                                         ; JR      0F99
________0F81:   #d8 $4E, $2D                                    ; JRE     0FB0

________0F83:   #d8 $45, $96, $80                               ; ONIW    96,80
________0F86:   #d8 $4E, $39                                    ; JRE     0FC1

________0F88:   #d8 $48, $2A                                    ; CLC
________0F8A:   #d8 $2A                                         ; LDAX    D
________0F8B:   #d8 $70, $D3                                    ; ADCX    H   	;Add HL-,DE-
________0F8D:   #d8 $3A                                         ; STAX    D
________0F8E:   #d8 $52                                         ; DCR     B
________0F8F:   #d8 $C1                                         ; JR      0F91
________0F90:   #d8 $08                                         ; RET

________0F91:   #d8 $23                                         ; DCX     D
________0F92:   #d8 $53                                         ; DCR     C
________0F93:   #d8 $C3                                         ; JR      0F97
________0F94:   #d8 $7F, $D3                                    ; CALF    0FD3	;Clear C,HL
________0F96:   #d8 $F3                                         ; JR      0F8A

________0F97:   #d8 $33                                         ; DCX     H
________0F98:   #d8 $F1                                         ; JR      0F8A

________0F99:   #d8 $48, $2B                                    ; STC
________0F9B:   #d8 $69, $99                                    ; MVI     A,99
________0F9D:   #d8 $56, $00                                    ; ACI     A,00
________0F9F:   #d8 $70, $E3                                    ; SUBX    H
________0FA1:   #d8 $70, $C2                                    ; ADDX    D
________0FA3:   #d8 $61                                         ; DAA
________0FA4:   #d8 $3A                                         ; STAX    D
________0FA5:   #d8 $52                                         ; DCR     B
________0FA6:   #d8 $C1                                         ; JR      0FA8
________0FA7:   #d8 $08                                         ; RET     

________0FA8:   #d8 $23                                         ; DCX     D
________0FA9:   #d8 $53                                         ; DCR     C
________0FAA:   #d8 $C3                                         ; JR      0FAE
________0FAB:   #d8 $7F, $D3                                    ; CALF    0FD3
________0FAD:   #d8 $ED                                         ; JR      0F9B

________0FAE:   #d8 $33                                         ; DCX     H
________0FAF:   #d8 $EB                                         ; JR      0F9B
;-----
________0FB0:   #d8 $48, $2A                                    ; CLC
________0FB2:   #d8 $2A                                         ; LDAX    D
________0FB3:   #d8 $70, $F3                                    ; SBBX    H
________0FB5:   #d8 $3A                                         ; STAX    D
________0FB6:   #d8 $52                                         ; DCR     B
________0FB7:   #d8 $C1                                         ; JR      0FB9
________0FB8:   #d8 $08                                         ; RET

________0FB9:   #d8 $23                                         ; DCX     D
________0FBA:   #d8 $53                                         ; DCR     C
________0FBB:   #d8 $C3                                         ; JR      0FBF
________0FBC:   #d8 $7F, $D3                                    ; CALF    0FD3
________0FBE:   #d8 $F3                                         ; JR      0FB2

________0FBF:   #d8 $33                                         ; DCX     H
________0FC0:   #d8 $F1                                         ; JR      0FB2
;------
________0FC1:   #d8 $48, $2A                                    ; CLC
________0FC3:   #d8 $2A                                         ; LDAX    D
________0FC4:   #d8 $70, $D3                                    ; ADCX    H
________0FC6:   #d8 $61                                         ; DAA
________0FC7:   #d8 $3A                                         ; STAX    D
________0FC8:   #d8 $52                                         ; DCR     B
________0FC9:   #d8 $C1                                         ; JR      0FCB
________0FCA:   #d8 $08                                         ; RET

________0FCB:   #d8 $23                                         ; DCX     D
________0FCC:   #d8 $53                                         ; DCR     C
________0FCD:   #d8 $C3                                         ; JR      0FD1
________0FCE:   #d8 $7F, $D3                                    ; CALF    0FD3
________0FD0:   #d8 $F2                                         ; JR      0FC3

________0FD1:   #d8 $33                                         ; DCX     H
________0FD2:   #d8 $F0                                         ; JR      0FC3
;------------------------------------------------------------
;Clear C,HL (for the add/sub routine above)
CALF____0FD3:   #d8 $6B, $00                                    ; MVI     C,00
________0FD5:   #d8 $34, $00, $00                               ; LXI     H,0000
________0FD8:   #d8 $08                                         ; RET
;------------------------------------------------------------
;[PC+1] INC/DEC Range of bytes from (HL)
;Extra byte's high bit sets Inc/Dec; rest is the byte counter.
CALT_AC_0FD9:   #d8 $48, $1F                                    ; POP     B
________0FDB:   #d8 $29                                         ; LDAX    B
________0FDC:   #d8 $12                                         ; INX     B
________0FDD:   #d8 $48, $1E                                    ; PUSH    B
________0FDF:   #d8 $1A                                         ; MOV     B,A
________0FE0:   #d8 $47, $80                                    ; ONI     A,80	;do we Dec?
________0FE2:   #d8 $CE                                         ; JR      0FF1

________0FE3:   #d8 $07, $7F                                    ; ANI     A,7F	;Counter can be 00-7F
________0FE5:   #d8 $1A                                         ; MOV     B,A
________0FE6:   #d8 $2B                                         ; LDAX    H		;Load a byte
________0FE7:   #d8 $66, $01                                    ; SUI     A,01	;Decrement it
________0FE9:   #d8 $3F                                         ; STAX    H-
________0FEA:   #d8 $48, $1A                                    ; SKN     CY		;Quit our function if any byte= -1!
________0FEC:   #d8 $C1                                         ; JR      0FEE
________0FED:   #d8 $08                                         ; RET

________0FEE:   #d8 $52                                         ; DCR     B
________0FEF:   #d8 $F6                                         ; JR      0FE6
________0FF0:   #d8 $08                                         ; RET

________0FF1:   #d8 $2B                                         ; LDAX    H		;or Load a byte
________0FF2:   #d8 $46, $01                                    ; ADI     A,01	;Add 1
________0FF4:   #d8 $3F                                         ; STAX    H-
________0FF5:   #d8 $48, $1A                                    ; SKN     CY		;Quit if any byte overflows!
________0FF7:   #d8 $C1                                         ; JR      0FF9
________0FF8:   #d8 $08                                         ; RET

________0FF9:   #d8 $52                                         ; DCR     B
________0FFA:   #d8 $F6                                         ; JR      0FF1
________0FFB:   #d8 $08                                         ; RET			;What a weird way to end a BIOS...
;------------------------------------------------------------
